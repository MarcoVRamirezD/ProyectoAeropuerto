...
public class ModificarAdministradorController implements Initializable {

    private Administrador administradorSesion = LoginAdministradorController.getAdministradorSesion();
    AdministradorGestor gestor = new AdministradorGestor();
    ...
    public void mostrar(){
        txtNombre.setText(""+administradorSesion.getNombre()+"");
        txtApellidos.setText(""+administradorSesion.getApellidos()+"");
        txtIdentificacion.setText(""+administradorSesion.getIdentificacion()+"");
        txtCorreo.setText(""+administradorSesion.getCorreo()+"");
        txtContrasenna.setText(""+administradorSesion.getContrasenna()+"");
        txtDireccion.setText(""+administradorSesion.getDireccion()+"");
        txtNacionalidad.setText(""+administradorSesion.getNacionalidad()+"");
        txtFechaNacimiento.setText(""+administradorSesion.getFechaNacimiento()+"");
        txtGenero.setText(""+administradorSesion.getGenero()+"");
    }

    public void modificarAdministrador(ActionEvent event) throws Exception{
        ...
        if (error){
            ...
            mensaje = gestor.modificarAdministrador(nombre, apellidos, identificacion, correo, contrasenna, direccion, nacionalidad, fechaNacimiento, genero);
            txtNombre.clear();
            txtApellidos.clear();
